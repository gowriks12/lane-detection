...
# works for road4 and road5
image_path = r"road4.jpg"
...
lines_img = displayLines(image, lines)

smooth_lines = getSmoothLines(image, lines)
smooth_lines_img = displayLines(image, smooth_lines)

# cv2.imshow("Output", smooth_lines_img)
